<?php global $post; ?>
<link rel="stylesheet"
      href="<?php echo plugins_url('css/wtt-social-metabox.min.css', dirname(__FILE__)) . "?ver=" . WTT_VERSION; ?>">
<script rel="text/javascript"
        src="<?php echo plugins_url('js/wtt-social-metabox.min.js', dirname(__FILE__)) . "?ver=" . WTT_VERSION; ?>"></script>

<div id="wtt-meta-social-section" class="wtt-meta-section">
    <form id="wtt-searchform" method="get" action="">
        ...
        <table class="wtt-social-meta-table">
            ...
            <tr>
                <td><input type="text" id="wtt_opengraph-title" size="36" name="wtt_opengraph-title"
                           value="<?php echo((get_post_meta($post->ID, '_wtt_opengraph-title', true) <> '') ? get_post_meta($post->ID, '_wtt_opengraph-title', true) : '') ?>"
                           class="large-text"
                           aria-describedby="wtt_opengraph-title-desc">
                    <p class="wtt_meta_description_info">A concise title for the related content. Keep this field empty
            ...
            <tr>
                <td><textarea class="large-text" rows="3" id="wtt_opengraph-description"
                    ...
                    <p class="wtt_meta_description_info">A description that concisely summarizes the content. Keep this
            ...
            <tr>
                <td><input id="wtt_opengraph-image" type="text" size="36"
                    ...
                    <p class="wtt_meta_description_info">A URL to a unique image representing the content of the page.
            ...
            <tr>
                <td>
                    ...
                    <p class="wtt_meta_description_info">A canonical tag is all about duplicate content and preferred
