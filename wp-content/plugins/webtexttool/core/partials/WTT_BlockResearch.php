<div class="wtt_box" ng-show="auth" ng-cloak>
    <div class="wtt_header">Enter your Keyword
    ...
    <div id="wtt_blocksearch" cg-busy="searchPromise"
        ...
        <div class="wtt-keyword" id="keyword-analysis-well">
            ...
            <div class="cl-lg-6">
                <div class="input-group">
                    <input type="text" class="form-control" placeholder="Search for..." type="text" id="wtt-keyword"
                           ...
                           tooltip-placement="top" tooltip-enable="!Keyword" value="">
                    <span class="input-group-btn">
                    <input class="wtt-btn wtt-btn-default" type="button" value="Go!"
            ...
            <div class="well well-custom well-step" id="related-keywords-well"
                ...
                <h2 style="color: #f09000; font-weight: 700; text-align: left !important;">Related keywords that
                            ...
                            <tr ng-repeat="relatedKeyword in searchModel.SearchResults">
                                <td><a href="javascript:;" class="keyBox"
                                       ...
                                       popover-title="More Info"><span
                                                class="keyword label {{relatedKeyword.OverallScoreLabelClass}}">{{relatedKeyword.Keyword}}</span></a>
                                </td>
        ...
        <div style="text-align:center;">
            <table class="wtt-form-table">
                ...
                <tr>
                    <td colspan="2">
                        <div>
                            <tags-input max-tags=3 enforce-max-tags ng-model="pageKeywordSynonyms" placeholder="Add" replace-spaces-with-dashes="false" class="ti-bootstrap wtt-edit" on-tag-added=onSynonymsAdded($tag) on-tag-removed=onSynonymsRemoved($tag)>
