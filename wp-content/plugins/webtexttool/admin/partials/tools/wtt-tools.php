                        ...
                        <form id="wtt_tools_form" name="tools"
                            ...
                            <div id="wtt_tools_body">
                                <div class="wtt_withborder">
                                    ...
                                    <p><strong>Disclaimer:</strong> Webtexttool is not responsible for any data loss. Use this tool at your own risk.</p>
                                    <p class="description"><span>Use the drop down below to choose which plugin you wish to
                                            import SEO data from.</span></p>
                                    <p class="description"><span>
                                        Click "Analyze" for a list of SEO data that can be imported into Webtexttool,
                                    ...
                                    <p class="description"><span>
                                        ...
                                        If a post or page already has SEO data in Webtexttool, we will not import the
