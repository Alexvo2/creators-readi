...
var k=" cp-slideInUp",l="cp-slideOutDown";break;case"top":var k=" cp-slideInDown",l="cp-slideOutUp"}jQuery(this).find(".cp-popup-content").removeClass("infobar_toggle_active"),h.css("display","block"),f.removeClass("cpro-open"),i.removeClass(l).addClass("cp-animated "+k),b._repositionInfoBar(f)}!c.hasClass("cpro-onload")||f.hasClass("cp_has_toggle")||f.hasClass("cp_has_infobar_toggle")||initConvertPro[e]._closepopupEvent()}),a(document).on("click",".cpro-overlay",function(b){var c=a(this),d=c.closest(".cp-popup-container").find("input[name=style_id]").val(),e=a(".cpro-onload[data-class-id="+d+"]"),f=a(".cp_style_"+d).find(".cp-popup-content");target=a(b.target),0!=a(".cp-popup-content").has(target).length||target.hasClass("cp-popup-content")||void 0!==f&&1==f.data("overlay-click")&&jQuery(document).trigger("closePopup",[e,d])}),a(window).on("update_test_status",function(a,b){var c=[],d=initConvertPro[b]._getCurrentABTest();-1!=d&&(c=jQuery.parseJSON(global_cp_cookies.get("cp_v2_ab_test_completed-"+d)),pendingArr=jQuery.parseJSON(global_cp_cookies.get("cp_v2_ab_test_pending-"+d)),jQuery.inArray(b,pendingArr)>=0&&(pendingArr=jQuery.grep(pendingArr,function(a){return a!=b}),c&&(c.push(b),global_cp_cookies.set("cp_v2_ab_test_completed-"+d,c,{expires:365})),global_cp_cookies.set("cp_v2_ab_test_pending-"+d,pendingArr,{expires:365})),global_cp_cookies.set("cp_v2_ab_test_display-"+d,!0,{expires:365}))}),a(window).on("cp_after_popup_open",function(c,d,e,f){a(window).outerWidth()<=500&&a(".cp_style_"+f).hasClass("cpro-open")&&(a(".cp_style_"+f).hasClass("cp-module-modal_popup")||a(".cp_style_"+f).hasClass("cp-module-full_screen"))&&a("html").addClass("cp-disable-scroll"),"full_screen"==e?a("html").addClass("cpro-exceed-viewport"):"welcome_mat"!=e&&b._modelHeight(),"modal_popup"==e&&jQuery("html").addClass("cp-modal-popup-open"),"info_bar"==e&&jQuery("body").hasClass("admin-bar")&&d.find(".cp-popup").hasClass("cp-top")&&b._repositionOverlayFields(d);var g=d.data("close-btnonload-delay");(g=Math.round(1e3*g))&&setTimeout(function(){d.find(".cp-close-container").removeClass("cp-hide-close")},g);var h=d.find(".cp-popup-content"),i=d.find(".cpro-animate-container"),j=h.data("entry-animation"),k=i.data("disable-animationwidth");i.parents(".cp-popup-wrapper").hasClass("cp-popup-inline");if(!d.closest(".cp-popup-container").hasClass("cp_has_infobar_toggle")||!d.closest(".cp-popup-container").hasClass("cp_has_toggle")){(a(window).width()>=k||void 0===k)&&void 0!==j&&a(i).addClass("cp-animated "+j)}if(d.closest(".cp-popup-container").hasClass("cp_has_infobar_toggle")){var l=d.closest(".cp-popup-container").find(".cp-open-infobar-toggle").attr("data-position"),m="translateY(0)";if(h.hasClass("toggle_active"))switch(l){case"bottom":case"top":m="translateX(-50%) translateY(0)"}else switch(l){case"bottom":m="translateX(-50%) translateY(100%)";break;case"top":m="translateX(-50%) translateY(-100%)"}if(void 0!==l&&null!==l)if(jQuery("#wpadminbar").length>0&&l.includes("top")){var n=jQuery("#wpadminbar").height();d.closest(".cp-popup-container").find(".cp-open-infobar-toggle");d.closest(".cp-popup-container").find(".cp-open-infobar-toggle").css("margin-top",n),d.closest(".cp-popup-container").find(".cp-open-infobar-toggle-wrap.cp-top").addClass("cp-animated").addClass("cp-slideInDown")}else l.includes("top")?d.closest(".cp-popup-container").find(".cp-open-infobar-toggle-wrap.cp-top").addClass("cp-animated").addClass("cp-slideInDown"):d.closest(".cp-popup-container").find(".cp-open-infobar-toggle-wrap.cp-bottom").addClass("cp-animated").addClass("cp-slideInUp");jQuery(".cp-module-info_bar .cp-popup-wrapper .cp-popup").css({transform:m})}else if(d.closest(".cp-popup-container").hasClass("cp_has_toggle")){var l=d.closest(".cp-popup-container").find(".cp-open-toggle").attr("data-position"),m="";if(h.hasClass("toggle_active"))switch(l){case"bottom-right":case"bottom-left":case"top-left":case"top-right":m="translateY(0)";break;case"bottom-center":case"top-center":m="translateX(-50%) translateY(0)";break;case"center-left":m="translateX(0%) translateY(-50%)";break;case"center-right":m="translateY(-50%) translateX(0%)"}else switch(l){case"bottom-right":case"bottom-left":m="translateY(100%)";break;case"bottom-center":m="translateX(-50%) translateY(100%)";break;case"top-left":case"top-right":m="translateY(-100%)";break;case"top-center":m="translateX(-50%) translateY(-100%)";break;case"center-left":m="translateY(-50%) translateX(-100%)";break;case"center-right":m="translateY(-50%) translateX(100%)"}if(void 0!==l&&null!==l){var o=d.closest(".cp-popup-container").find(".cp-open-toggle").data("position");if(jQuery("#wpadminbar").length>0&&l.includes("top")){var n=jQuery("#wpadminbar").height(),p=d.closest(".cp-popup-container").find(".cp-open-toggle");"sticky"==p.data("type")&&d.closest(".cp-popup-container").find(".cp-open-toggle-wrap, .cp-popup").addClass("cp-animated").addClass("cp-slideInDown"),"hide_on_click"==p.data("type")&&("top-left"!=o&&"top-right"!=o&&"top-center"!=o||d.closest(".cp-popup-container").find(".cp-open-toggle-wrap, .cp-popup").addClass("cp-animated").addClass("cp-slideInDown"),d.closest(".cp-popup-container").find(".cp-open-toggle").css("margin-top",n),d.closest(".cp-popup-container").find(".cp-open-toggle-wrap").addClass("cp-animated").addClass("cp-slideInDown"))}else switch(o){case"bottom-right":case"bottom-left":case"bottom-center":d.closest(".cp-popup-container").find(".cp-open-toggle-wrap, .cp-popup").addClass("cp-animated").addClass("cp-slideInUp");break;case"top-left":case"top-right":case"top-center":d.closest(".cp-popup-container").find(".cp-open-toggle-wrap, .cp-popup").addClass("cp-animated").addClass("cp-slideInDown");break;case"center-left":d.closest(".cp-popup-container").find(".cp-open-toggle-wrap, .cp-popup").addClass("cp-animated").addClass("cp-slideInLeft");break;case"center-right":d.closest(".cp-popup-container").find(".cp-open-toggle-wrap, .cp-popup").addClass("cp-animated").addClass("cp-slideInRight")}}jQuery(".cp-open-toggle-wrap.cp-toggle-type-sticky .cp-open-toggle").css("visibility","visible"),a(window).outerWidth()>=768&&"top-center"!=l&&"bottom-center"!=l?h.css({transform:m}):h.css({transform:m+"translateX(-50%)"})}"info_bar"==e&&b._cpInfobarPosition(d),"slide_in"==e&&b._cpSlideInPosition(d),setTimeout(function(){a(document).trigger("cp-load-field-animation",[d])},1e3)}),jQuery(document).on("cp-trigger-design",function(a,b){void 0!==initConvertPro[b]&&initConvertPro[b].invokePopup()})}(jQuery),function(a,b,c){var d=!0;a(b).ready(function(){function c(c,d){var g=c.closest(".cp-popup-content").data("step"),h=c.closest(".cp-popup-wrapper").find("input[name=style_id]").val(),i=a(".cpro-onload[data-class-id="+h+"]"),j=c.hasClass("cpro_count_conversion");if(a(document).trigger("cpro_before_field_actions",[c,h]),j){var k=c.closest(".cp-popup-container").data("styleslug");"function"==typeof cpCreateGoogleAnalyticEvent&&cpCreateGoogleAnalyticEvent("Convert Pro","conversion",k);(new ConvertProPopup)._setCookie(c)}switch(d){case"close":a(document).trigger("closePopup",[i,h]);break;case"close_tab":b.top.close();break;case"goto_step":var l=c.closest(".cp-field-html-data").data("step");if(g!=l){var m=c.closest(".cpro-form-container").find("input, select, textarea");if(c.closest(".cpro-form-container").find(".cpro-checkbox-required").each(function(a,b){var c=jQuery(this),d=jQuery(this).find("input[type=checkbox]:checked").length;if(setTimeout(function(a){c.find("input[type=checkbox]").removeAttr("required")},2e3),0==d){var e=jQuery(this).find("input[type=checkbox]:first");if(void 0!==e)return e.attr("required","required"),e[0].reportValidity(),!1}}),m.length>0){var n=!0;g<l&&a.each(m,function(a,b){if(!b.checkValidity())return n=!1,b.reportValidity(),!1}),n&&e(c,g,l)}else e(c,g,l)}break;case"goto_url":var o=c.data("redirect"),p=c.data("redirect-target");void 0!==p&&""!=p||(p="_self"),""!==o&&("_self"!==p?b.open(o,p):o.indexOf(".pdf")>0?f(o):b.location=o)}}function e(a,b,c){a.closest(".cp-popup").find(".cp-popup-content.cp-panel-"+c).length>0&&(a.closest(".cp-popup").find(".cp-popup-content.cp-panel-"+b).removeClass("cpro-active-step"),a.closest(".cp-popup").find(".cp-popup-content.cp-panel-"+c).addClass("cpro-active-step"))}function f(b){var c=b.lastIndexOf("/")+1,d=b.substr(c),e=a("<a>");e.attr("href",b),e.attr("download",d),e.text("cpro_anchor_link"),e.addClass("cpro_dummy_anchor"),a("body").append(e),a(".cpro_dummy_anchor")[0].click(),setTimeout(function(){a(".cpro_dummy_anchor").remove()},500)}var g=a('.cpro-form input[name="style_id"]').val();styleIdSelctor="cp_popup_style_"+g,a(document).on("click",".cp-target.cp-button-field",function(){var b=a(this);b.closest(".cp-field-html-data").data("action");a(".cp-current-clicked-btn").removeClass("cp-current-clicked-btn"),b.closest(".cp-field-html-data").addClass("cp-current-clicked-btn")}),a(document).on("click",".cp-field-html-data.cp-shapes-wrap",function(){var b=a(this),c=b.closest(".cp-field-html-data").data("action");"submit"!=c&&"submit_n_close"!=c&&"submit_n_goto_step"!=c&&"submit_n_goto_url"!=c||0==a(".cp_shape_submit_hidden").length&&b.find(".cp_shape_submit_label").append('<input type="submit" class="cp_shape_submit_hidden">'),a(".cp-current-clicked-shape").removeClass("cp-current-clicked-shape"),b.closest(".cp-field-html-data").addClass("cp-current-clicked-shape")}),jQuery(document).on("submit","form.cpro-form",function(c){c.preventDefault();var g=!1,h=!1,i=jQuery(this);jQuery(document).trigger("cp_before_form_submit",[jQuery(this)]);var j=!0;if(jQuery(this).find(".cpro-checkbox-required").each(function(a,b){var c=jQuery(this);if(setTimeout(function(){c.find("input[type=checkbox]").removeAttr("required")},2e3),0==jQuery(this).find("input[type=checkbox]:checked").length)return jQuery(this).find("input[type=checkbox]:first").attr("required","required"),i[0].reportValidity(),j=!1,!1}),d=!!j){var k=jQuery(this),l=k.closest(".cp-popup-container").data("style").replace("cp_style_",""),m=k.closest(".cp-popup-container").data("styleslug"),n="",o=k.serialize();k.closest(".cpro-form-container");redirectdata=k.data("redirect-lead-data"),currentBtn=k.find(".cp-current-clicked-btn"),currentShape=k.find(".cp-current-clicked-shape"),currentBtnAction=currentBtn.closest(".cp-field-html-data").data("action"),success_message=currentBtn.find(".cp-button-field").data("success-message"),currentShpAction=currentShape.closest(".cp-field-html-data").data("action"),success_message_shp=currentShape.data("success-message"),loader_style="loader_1",currObj="",n=currentBtn.find(".cp-button-field").html(),shape_old_text=currentShape.html();var p=currentBtn.find(".cp-button-field");"cp_button"!=currentBtn.attr("data-type")&&"cp_gradient_button"!=currentBtn.attr("data-type")||(currObj=currentBtn,p.removeClass("cp-tooltip cp-tooltip-top cp-tooltip-bottom cp-loader"),p.find(".cp_loader_container").removeClass("cp_success_loader_container"),currentBtn.hasClass("cp-state-loading")||currentBtn.hasClass("cp-state-success")||currentBtn.hasClass("cp-state-error")||(currentBtn.addClass("cp-state-loading"),p.addClass("cp-loader cp-button-loading"),currentBtn.find(".cp-loader").css("text-align","center"),p.html("<div class='cp_loader_container'><i class='cp-button-loader-style draw "+loader_style+"'></i></div>"),"submit_n_close"!=currentBtnAction&&"submit"!=currentBtnAction&&"submit_n_goto_url"!=currentBtnAction||p.addClass("cp-button-tooltip"))),"cp_shape"==currentShape.attr("data-type")&&(currObj=currentShape,currentShape.find(".cp-shape-container").removeClass("cp-tooltip-top cp-tooltip-bottom"),currentShape.removeClass("cp-shape-submit-loading cp-state-success cp-error-tooltip"),currentShape.hasClass("cp-state-loading")||currentShape.hasClass("cp-state-success")||currentShape.hasClass("cp-state-error")||(currentShape.addClass("cp-shape-submit-loading"),"submit_n_close"!=currentShpAction&&"submit"!=currentShpAction&&"submit_n_goto_url"!=currentShpAction||currentShape.find(".cp-shape-submit-loading").addClass("cp-shapes-tooltip"))),void 0!==cp_ajax.ajax_nonce&&(o+="&_nonce="+cp_ajax.ajax_nonce),close_span='<span class="cp-tooltip-close">&times;</span>';var q=i.find('[name="param[email]"]'),r=q.val();jQuery.ajax({url:cp_ajax.url,data:o,type:"POST",dataType:"json",success:function(c){var d=currentBtn.closest(".cp-popup-wrapper").find("input[name=style_id]").val(),i=a(".cpro-onload[data-class-id="+d+"]"),j=currentBtn.find(".cp-button-field");if(j.find(".cp_loader_container").addClass("cp_success_loader_container"),j.find(".cp-button-loader-style").removeClass(loader_style).addClass("success-loader-style"),result=c.data,error_msg=cp_ajax.not_connected_to_mailer,currentBtn.find(".cp-target").hasClass("cp-button-field")){var k=currentBtn.find(".cp-button-field").offset().top-a(b).scrollTop();k>90?currentBtn.find(".cp-button-field").addClass("cp-tooltip-top"):currentBtn.find(".cp-button-field").addClass("cp-tooltip-bottom"),currentBtn.removeClass("cp-state-loading").addClass("cp-state-success").attr("style","z-index: 999 !important")}else if(currentShape.hasClass("cp-shapes-wrap")){var k=currentShape.offset().top-a(b).scrollTop();k>90?currentShape.find(".cp-shape-container").addClass("cp-tooltip-top"):currentShape.find(".cp-shape-container").addClass("cp-tooltip-bottom"),currentShape.removeClass("cp-state-loading").addClass("cp-state-success").attr("style","z-index: 999 !important")}if(0===c)g=!1,currentBtn.find(".cp-target").hasClass("cp-button")?(currentBtn.removeClass("cp-current-clicked-btn").addClass("cp-error-tooltip"),currentBtn.find(".cp-btn-tooltip").html('<div class="cp-error-tip-content">'+error_msg+close_span+"</div>")):currentShape.hasClass("cp-shapes-wrap")&&(currentShape.removeClass("cp-current-clicked-shape").addClass("cp-error-tooltip"),currentShape.find(".cp-shape-tooltip").html('<div class="cp-error-tip-content">'+error_msg+close_span+"</div>"));else if(0!=result.error)"Invalid email address."==result.error&&(error_msg="Invalid Email Address",h=!0),g=!1,currentBtn.find(".cp-target").hasClass("cp-button")?(currentBtn.removeClass("cp-current-clicked-btn").removeClass("cp-state-success").addClass("cp-error-tooltip"),currentBtn.find(".cp-button-field").find(".cp_success_loader_container").remove(),jQuery("<div/>",{addClass:"cp_loader_container cp_error_loader_container"}).appendTo(currentBtn.find(".cp-button-field")),currentBtn.find(".cp_error_loader_container").append("<i class='dashicons-no-alt dashicons'></i>"),jQuery("<div/>",{class:"cp-error-tip-content"}).appendTo(currentBtn.find(".cp-btn-tooltip")),currentBtn.find(".cp-error-tip-content").append(error_msg+close_span)):currentShape.hasClass("cp-shapes-wrap")&&(currentShape.removeClass("cp-current-clicked-shape").removeClass("cp-state-success").addClass("cp-error-tooltip"),currentShape.find(".cp-shape-tooltip").html('<div class="cp-error-tip-content">'+error_msg+close_span+"</div>"),currentShape.find(".cp-button-field").html("<div class='cp_loader_container cp_error_loader_container'><i class='dashicons-no-alt dashicons'></i></div>"));else{if(g=!0,0==result.error)if(currentBtn.find(".cp-target").hasClass("cp-button"))switch(currentBtn.removeClass("cp-error-tooltip").addClass("cp-state-success"),currentBtn.find(".cp-button-field").attr("data-content",success_message),currentBtn.find(".cp-button-field").attr("disabled",!0),currentBtnAction){case"submit_n_close":setTimeout(function(){jQuery(document).trigger("closePopup",[i,d])},1200);break;case"submit_n_goto_step":var l=currentBtn.closest(".cp-field-html-data").data("step"),o=currentBtn.closest(".cp-popup-content").data("step");o!=l&&setTimeout(function(){e(currentBtn,o,l)},1200);break;case"submit_n_goto_url":var p=currentBtn.closest(".cp-field-html-data").data("redirect"),q=currentBtn.closest(".cp-field-html-data").data("redirect-target"),s=currentBtn.find(".cp-target").data("get-param"),t=currentBtn.closest(".cpro-form").serializeArray();for(param_index=0;param_index<t.length;++param_index)if(""==t[param_index].value||"param[date]"==t[param_index].name||"action"==t[param_index].name||"style_id"==t[param_index].name)delete t[param_index];else{var u=t[param_index].name.replace("param[","");u=u.substring(0,u.length-1),t[param_index].name=u}var t=t.filter(function(a){return""!==a});if(t=jQuery.param(t),1==s){var v=p.split("?");p=1==v.length?p+"?"+t:p+"&"+t}setTimeout(function(){void 0!==q&&""!=q||(q="_self"),""!==p&&("_self"!==q?b.open(p,q):p.indexOf(".pdf")>0?f(p):b.location=p,"_blank"==q&&jQuery(document).trigger("closePopup",[i,d]))},1200)}else if(currentShape.hasClass("cp-shapes-wrap"))switch(currentShape.removeClass("cp-error-tooltip").removeClass("cp-shape-submit-loading").addClass("cp-state-success"),currentShape.attr("style","z-index: 35 !important"),currentShape.find(".cp-shape-container").attr("data-content",success_message_shp),currentShpAction){case"submit_n_close":var d=currentShape.closest(".cp-popup-wrapper").find("input[name=style_id]").val(),i=a(".cpro-onload[data-class-id="+d+"]");setTimeout(function(){jQuery(document).trigger("closePopup",[i,d])},1200);break;case"submit_n_goto_step":currentShape.find(".cp-shape-container").removeClass("cp-tooltip-top").removeClass("cp-tooltip-bottom");var l=currentShape.closest(".cp-field-html-data").data("step"),o=currentShape.closest(".cp-popup-content").data("step");o!=l&&setTimeout(function(){e(currentShape,o,l)},1200);break;case"submit_n_goto_url":var p=currentShape.closest(".cp-field-html-data").data("redirect"),q=currentShape.closest(".cp-field-html-data").data("redirect-target"),s=currentShape.find(".cp-target").data("get-param"),t=currentShape.closest(".cpro-form").serializeArray();for(param_index=0;param_index<t.length;++param_index)if(""==t[param_index].value||"param[date]"==t[param_index].name||"action"==t[param_index].name||"style_id"==t[param_index].name)delete t[param_index];else{var u=t[param_index].name.replace("param[","");u=u.substring(0,u.length-1),t[param_index].name=u}var t=t.filter(function(a){return""!==a});if(t=jQuery.param(t),1==s){var v=p.split("?");p=1==v.length?p+"?"+t:p+"&"+t}setTimeout(function(){void 0!==q&&""!=q||(q="_self"),""!==p&&("_self"!==q?b.open(p,q):p.indexOf(".pdf")>0?f(p):b.location=p,"_blank"==q&&jQuery(document).trigger("closePopup",[i,d]))},1200)}else currentBtn.find(".cp-target").hasClass("cp-button")?(currentBtn.addClass("cp-error-tooltip"),currentBtn.find(".cp-button-field").attr("data-content",result.error)):currentShape.hasClass("cp-shapes-wrap")&&(currentShape.removeClass("cp-current-clicked-shape").addClass("cp-error-tooltip"),currentShape.find(".cp-shape-container").attr("data-content",result.error));var w=new ConvertProPopup;w._setCookie(currObj)}setTimeout(function(){h&&(currentBtn.length>0&&(currentBtn.find(".cp-button-field").html(n),currentBtn.find(".cp-button-field").removeClass("cp-tooltip-top cp-tooltip-bottom"),currentBtn.closest(".cp-field-html-data").find(".cp-error-tip-content").remove()),currentShape.length>0&&(currentShape.find(".cp-shape-container").html(shape_old_text),currentShape.find(".cp-shape-container").removeClass("cp-tooltip-top cp-tooltip-bottom"),currentShape.closest(".cp-field-html-data").find(".cp-error-tip-content").remove()))},1500),setTimeout(function(){currentBtn.find(".cp-target .cp_loader_container").hasClass("cp_success_loader_container")?currentBtn.find(".cp-button-field").removeClass("cp-tooltip-top cp-tooltip-bottom"):currentShape.hasClass("cp-shapes-wrap")&&!currentShape.hasClass("cp-error-tooltip")&&currentShape.find(".cp-shape-container").removeClass("cp-tooltip-top cp-tooltip-bottom")},5e3),currentBtn.removeClass("cp-current-clicked-btn"),currentShape.removeClass("cp-current-clicked-shape"),h||jQuery(document).trigger("cp_after_form_submit",[jQuery(this),c,m,r])},error:function(a){g=!1,currentBtn.find(".cp-button-field").attr("data-content",a)}})}h||jQuery(document).trigger("cp_after_submit_action",[jQuery(this),l,g]),c.preventDefault()}),a(document).on("click",".cp-tooltip-close",function(b){var c=a(this),d=c.closest("form.cpro-form");d.find(".cp-current-clicked-btn"),d.find(".cp-current-clicked-shape");c.closest(".cp-error-tip-content").remove(),d.find(".cp-button-field").removeClass("cp-button-tooltip"),d.find(".cp-shape-container").removeClass("cp-tooltip-top")}),a(document).on("click",".cp-field-html-data",function(){var b=a(this),d=b.data("action");c(b,d),"cp_button"!==jQuery(this).data("type")&&"cp_gradient_button"!==jQuery(this).data("type")&&b.removeClass("cp-current-clicked-btn"),"cp_shape"!==jQuery(this).data("type")&&b.removeClass("cp-current-clicked-shape")})})}(jQuery,window);var CProVideo="";!function(a){CProVideo={init:function(b,c,d){a(window).on("cp_after_popup_open",this._playVideo),a(document).on("closePopup",this._stopVideo)},_playVideo:function(a,b,c,d){b.find(".cpro-video-container").each(function(){var a=jQuery(this).closest(".cp-field-html-data"),b=a.data("autoplay"),c=a.data("src"),d=a.find("iframe"),e=d.attr("src");switch(d.attr("id"),c){case"youtube":b&&(e=e.replace("&autoplay=0",""),e+="&autoplay=1",d.attr("src",e));break;case"vimeo":b&&(e+="?autoplay=1",d.attr("src",e));break;case"custom_url":b&&setTimeout(function(){a.find(".cpro-video-iframe")[0].play()},500)}})},_stopVideo:function(b,c,d){a(".cp_style_"+d).find(".cp-video-wrap").each(function(){var b=a(this),c=b.data("src"),d=b.find("iframe"),e=d.attr("src");switch(c){case"youtube":case"vimeo":d.prop("src","").prop("src",e.replace("?autoplay=1",""));break;case"custom_url":b.find("video")[0].pause()}})}},CProVideo.init()}(jQuery);