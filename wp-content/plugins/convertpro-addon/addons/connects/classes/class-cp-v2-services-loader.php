...
if ( ! class_exists( 'Cp_V2_Services_Loader' ) ) {
	...
	final class Cp_V2_Services_Loader {
		...
		public function add_test_conn_btn( $account_name, $service, $has_test ) {
			...
			<a href="javascript:void(0);" data-account="<?php echo $account_name; ?>" data-service="<?php echo $service; ?>" class="cp-btn-default <?php echo $hidden_class; ?> cp-primary-button cp-test-connection"><?php _e( 'Test Connection', 'convertpro-addon' ); ?>
			</a>
